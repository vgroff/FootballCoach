        ...
        while collected < n_steps:
            ...
            for sec in getattr(env, "last_secondary_results", []):
                buffer.add(
                    ...
                    # matching secondary buffer.add() call for why this is
                    # real data (NeuralPlayerAI.last_transition sets it the
                    # same way for trainee and secondary players), not a
